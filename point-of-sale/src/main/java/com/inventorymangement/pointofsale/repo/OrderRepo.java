...
public interface OrderRepo extends JpaRepository<Order,Integer> {
    ...
    @Query(value = "select c.customer_name as customerName, c.customer_address as customerAddress, c.contact_number as contactNumber, " +
            ...
            "where c.active_status = ?1 and c.customer_id = o.customer_id",nativeQuery = true)
    List<OrderDatailsInterface> getAllOrderDetails(boolean status, Pageable pageable);
